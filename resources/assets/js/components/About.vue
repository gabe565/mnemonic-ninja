<template>
    <div class="container">
        ...
        <hr>
        <div class="row">
            <div class="col-md-10 mx-sm-auto">
                <p>
        ...
        <div class="row">
            <div class="col-md-10 mx-sm-auto">
                ...
                <table class="table dataTable table-sm table-bordered table-striped table-condensed" cellspacing="0" style="width: 100%">
                    <thead>
                        <tr>
                            <th class="all">
        ...
        <div class="row">
            <div class="col-md-10 mx-sm-auto">
                ...
                <p>
                To see this in action, <router-link to="/convert/word/garage garages garagez">look at the conversions of <code>garage</code>, <code>garages</code>, and <code>garagez</code></router-link>:
                <ol>
...
export default {
    ...
    mounted() {
        this.table = $('.dataTable').DataTable({
            fixedHeader: {
                headerOffset: 0 //$('.navbar').outerHeight()
            },
            info: false,
            ordering: false,
            paging: false,
