        ...
        <v-col>
          ...
          <p>
            ...
            <ol>
              ...
              <li>Now to see the wordlist in action. <code>garagez</code> will convert to "7470" because the word is not in the wordlist, so the system has to guess on the conversion.</li>
            </ol>
          </p>
          <p>
